...
function sumIndexOdd_inArray(array) {
    // A function accepting an array, and returning the sum of all elements of odd index position. Return null if parameter is not an array.
    if (!Array.isArray(array)) {return null}  // validation
